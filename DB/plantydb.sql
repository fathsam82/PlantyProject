...
INSERT INTO `plant` (`id`, `name`, `description`, `price`, `stock_quantity`, `plant_image_url`, `size`, `is_discounted`, `plant_category_id`, `enabled`) VALUES (3, 'Aloe Vera', '(Disclamer - Harmful to cats and dogs. Be cautious about where you place this one.) Medium length green succulent leaves that are prickly. It is well known for offering possible health and beauty benefits. It\'s toxic to cats and dogs so we advise caution to where it\'s placed in your home.', 1100, 1000000, 'https://m.media-amazon.com/images/I/713BlHvw8VL.__AC_SX300_SY300_QL70_FMwebp_.jpg', 'medium', 1, 3, 1);
