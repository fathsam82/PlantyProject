...
START TRANSACTION;
USE `plantydb`;
INSERT INTO `plant` (`id`, `name`, `description`, `price`, `stock_quantity`, `plant_image_url`, `size`, `is_discounted`, `plant_category_id`, `enabled`) VALUES (1, 'Snake Plant', 'Known for its durability and adaptability, the Snake Plant thrives even in lowlight conditions and is exceptionally low maintenance. Its sophisticated appearance enhances the aesthetics of your interior, making it a timeless addition to any room.', 1000, 1000000, 'https://target.scene7.com/is/image/Target/GUEST_71909e47-2c05-418f-a124-cf3910389a15?wid=1200&hei=1200&qlt=80&fmt=webp', 'medium', 1, 1, 1);
...
INSERT INTO `plant` (`id`, `name`, `description`, `price`, `stock_quantity`, `plant_image_url`, `size`, `is_discounted`, `plant_category_id`, `enabled`) VALUES (3, 'Aloe Vera', 'The Aloe Vera is a medium length green succulent leaves that are prickly. It is well known for offering possible health and beauty benefits. It\'s toxic to cats and dogs so we advise caution to where it\'s placed in your home.', 1100, 1000000, 'https://m.media-amazon.com/images/I/713BlHvw8VL.__AC_SX300_SY300_QL70_FMwebp_.jpg', 'medium', 1, 3, 1);
...
INSERT INTO `plant` (`id`, `name`, `description`, `price`, `stock_quantity`, `plant_image_url`, `size`, `is_discounted`, `plant_category_id`, `enabled`) VALUES (5, 'Lily Plant', 'Being a tropical plant, the Lily Plant prefers high levels of humidity. If the leaf edges turn brown, supply more humidity by grouping it with more houseplants. Grow in bright, indirect sunlight and enjoy!', 2000, 1000000, 'https://m.media-amazon.com/images/I/81jEsBi-oJL.__AC_SX300_SY300_QL70_FMwebp_.jpg', 'large', 0, 1, 1);
...
INSERT INTO `plant` (`id`, `name`, `description`, `price`, `stock_quantity`, `plant_image_url`, `size`, `is_discounted`, `plant_category_id`, `enabled`) VALUES (7, 'Rattlesnake Plant', 'The Rattlesnake Plants is known for its air-purifying qualities, making it a great addition to any indoor environment. The plant prefers indirect sunlight and consistently moist soil to thrive.', 2000, 1000000, 'https://m.media-amazon.com/images/I/71rY2lmCyaL._AC_SX679_.jpg', 'medium', 0, 1, 1);
INSERT INTO `plant` (`id`, `name`, `description`, `price`, `stock_quantity`, `plant_image_url`, `size`, `is_discounted`, `plant_category_id`, `enabled`) VALUES (8, 'Ponytail Palm', 'Ponytail Palms add touch of unique personality to any space. Ponytail bonsai houseplants are ready to be set on any tabletop, desk, side table, or windowsill, serving as a cute focal point in any room.', 2500, 1000000, 'https://m.media-amazon.com/images/I/81mfRkOdZZL._AC_SX679_.jpg', 'medium', 0, 1, 1);
INSERT INTO `plant` (`id`, `name`, `description`, `price`, `stock_quantity`, `plant_image_url`, `size`, `is_discounted`, `plant_category_id`, `enabled`) VALUES (9, 'ZZ Plant', 'Bring home a beautiful easy-to-grow ZZ plant for a tropical feel. This houseplant has shiny, dark leaves, adding flair to any space. ZZ improves room aesthetic, bringing a focal point to any living room, office, or bedroom decor.', 1500, 1000000, 'https://m.media-amazon.com/images/I/51mxDUtfWRL._AC_SX679_.jpg', 'medium', 0, 1, 1);
...
INSERT INTO `plant_origin` (`id`, `name`, `latitude`, `longitude`, `plant_id`) VALUES (5, 'Columbia', 4.1755, -74.2973, 5);
...
INSERT INTO `plant_origin` (`id`, `name`, `latitude`, `longitude`, `plant_id`) VALUES (8, 'Mexico', 20.6668, -97.6480, 8);
INSERT INTO `plant_origin` (`id`, `name`, `latitude`, `longitude`, `plant_id`) VALUES (9, 'Kenya', -2.3333, 37.8667, 9);
